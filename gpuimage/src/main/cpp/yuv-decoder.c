...
Java_com_poney_gpuimage_view_GPUImageNativeLibrary_YUVtoRBGA(JNIEnv *env, jobject obj,
                                                             jbyteArray yuv420sp,
...
JNIEXPORT void JNICALL
Java_com_poney_gpuimage_view_GPUImageNativeLibrary_YUVtoARBG(JNIEnv *env, jobject obj,
                                                             jbyteArray yuv420sp,
                                                             jint width, jint height,
                                                             jintArray rgbOut) {
...
JNIEXPORT void JNICALL
Java_com_poney_gpuimage_view_GPUImageNativeLibrary_adjustBitmap(JNIEnv *jenv,
                                                                jclass thiz,
                                                                jobject src) {
